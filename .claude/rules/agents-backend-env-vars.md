---
paths:
  - "qubership-apihub-agents-backend/qubership-apihub-agents-backend/service/system_info.go"
  - "qubership-apihub-agents-backend/qubership-apihub-agents-backend/**/*.go"
---
